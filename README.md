...
| 模块 | 说明 |
|------|------|
| 🏠 **首页** | 品牌展示 + 版本选择（速测 28 题 / 完整 60 题） + 16 型百科入口 |
| 📝 **答题** | 逐题呈现，毛玻璃选中动画，进度条，支持回退修改答案 |
| 📊 **结果** | 类型展示 + 四维倾向图 + 性格画像 + 优势盲区 + 职业方向 + 兼容类型 |
| 🎴 **分享卡片** | Canvas 2D 绘制精美分享图，一键保存到相册 |
| 📋 **历史记录** | 本地存储历史测试结果，支持回看和对比 |
| 📖 **16 型百科** | 浏览全部 16 种人格类型，查看完整详情 |
| 🔗 **匹配度** | 任意两种类型的匹配度分析（总览 / 沟通 / 工作 / 情感） |
